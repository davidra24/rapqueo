                ...
                <md-card-content>
                  <div class="md-layout md-gutter">
                    ...
                    >
                      ...
                      <h6>
                        Peso: {{ promo.producto.caracteristicas.peso
                        }}{{ promo.producto.caracteristicas.unidad }}
                      </h6>
                      <h6>
                        Cantidad: {{ promo.producto.caracteristicas.cantidad }}
                      </h6>
                      <h6>
                        Precio: ${{ promo.producto.caracteristicas.precio }}
                      </h6>
                    </div>
